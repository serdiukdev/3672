...
import 'package:itd_2/models/income.dart';
...
class FinanceRepository {
  ...
  Future<UserFinanceState> getFinanceState() async {
    ...
    final savedGoal = double.tryParse(prefs.getString('goal_saving') ?? '') ?? 0;
    final expenseGoal = double.tryParse(prefs.getString('goal_limit') ?? '') ?? 0;
  ...
  Future<void> _saveFinanceState(SharedPreferences prefs, UserFinanceState state) async {
