...
import 'package:itd_2/models/achievements.dart';
import 'package:itd_2/models/expense.dart';
...
class AchievementService {
  ...
  static List<AchievementBase> loadBase() => const [
        AchievementBase(
          ...
          description: 'Record your very first expense and start growing your nest of financial habits.',
        ),
        AchievementBase(
          title: 'Seven Sunrise Streak',
          description: 'Log into the app for 7 consecutive days and keep your farmyard momentum strong.',
        ),
        AchievementBase(
          title: 'Loyal Rooster',
          description: 'Reach a 30-day login streak and prove you’re a devoted keeper of the coop.',
        ),
        AchievementBase(
          title: 'Legendary Farmer',
          description: 'Hit a 100-day login streak and become a true master of your financial barnyard.',
        ),
        AchievementBase(
          title: 'Market Expert',
          description: 'Track 50 shopping expenses and show you know every grain that leaves your feed bin.',
        ),
        AchievementBase(
          title: 'Feeding Time Regular',
          description: 'Log 25 dining or café expenses, proving you can enjoy good meals while keeping track of every crumb.',
        ),
        AchievementBase(
          title: 'Bill Tamer',
          description: 'Record 20 bill payments and show you keep your farm running like clockwork.',
        ),
        AchievementBase(
          title: 'Barnyard Entertainer',
          description: 'Track 30 entertainment expenses and balance fun with your saving goals.',
        ),
        AchievementBase(
          title: 'Field Scholar',
          description: 'Log 10 education-related expenses and invest in the greatest crop of all — knowledge.',
        ),
        AchievementBase(
          title: 'Feather & Flair',
          description: 'Record 15 self-care expenses, showing you know when to preen your feathers without plucking your savings.',
        ),
        AchievementBase(
          title: 'Hobby Harvester',
          description: 'Track 20 hobby expenses and prove you can enjoy your pastures responsibly.',
        ),
        AchievementBase(
          title: 'Road Rooster',
          description: 'Log 40 transportation expenses and show you account for every mile you travel.',
        ),
        AchievementBase(
          title: 'Style in the Coop',
          description: 'Record 25 clothing expenses while keeping both your wardrobe and wallet tidy.',
        ),
        AchievementBase(
          title: 'Farm Explorer',
          description: 'Track 5 travel expenses and prove you can wander far without emptying your nest.',
        ),
        AchievementBase(
          title: 'Health Hen',
          description: 'Log 20 health-related expenses, showing you invest wisely in your most valuable asset — yourself.',
        ),
        AchievementBase(
          title: 'Animal Caretaker',
          description: 'Record 15 pet or livestock expenses and show you care for every creature under your roof.',
        ),
        AchievementBase(
          title: 'Coop Builder',
          description: 'Track 30 home or farm upkeep expenses while crafting your dream homestead with smart planning.',
        ),
        AchievementBase(
          title: 'Kindhearted Giver',
          description: 'Log 10 gift expenses and prove you can share your harvest while still saving seed for tomorrow.',
        ),
        AchievementBase(
          title: 'Charitable Chicken',
          description: 'Record 5 donation expenses and show your heart is as golden as your grain.',
        ),
        AchievementBase(
          title: 'Master of the Coop',
          description: 'Complete 500 total expense entries across all categories and become the true guardian of your financial farm.',
        ),
      ];

  static List<Achievement> loadBaseForUI() => loadBase().map(Achievement.fromBase).toList();
  ...
  static Future<void> setProgress(String id, int value) async {
    ...
    final updated = base.copyWith(currentValue: newVal, isCompleted: newVal >= goal);
  ...
  static Future<void> updateLoginStreakForToday(StorageService storage) async {
    ...
    if (lastOpen == null) {
      ...
      try {
        ...
        if (lastDate.year == yesterday.year && lastDate.month == yesterday.month && lastDate.day == yesterday.day) {
          streak = streak + 1;
        } else {
          streak = 1;
        }
