...
import '../../blocs/history/bloc.dart';
import '../../blocs/statistic/state.dart';
import '../../general_components/nav_bar.dart';
import '../../general_components/period_picker_panel.dart';
...
class _ChoosePeriodHistoryState extends State<ChoosePeriodHistory> {
  ...
  bool _inRange(DateTime d) {
    ...
    return (x.isAfter(s) || x.isAtSameMomentAs(s)) && (x.isBefore(e) || x.isAtSameMomentAs(e));
  }
  ...
  Future<void> _onOk() async {
    ...
    if (!mounted) return;
    context.pushNamedAndRemoveUntil(HistoryListScreen.routeName, arguments: widget.mode);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () => context.pushNamedAndRemoveUntil(ChooseMonthHistory.routeName, arguments: widget.mode),
                          ...
                          child: Container(
                            ...
                            child: Text(
                              ...
                              style: selected
                                  ...
                                  : AppStyles.categoryItem.copyWith(fontSize: 18, color: Colors.white.withOpacity(0.5)),
