...
import '../../blocs/achievements/bloc.dart';
import '../../blocs/achievements/state.dart';
...
class _AchievementsScreenState extends State<AchievementsScreen> {
  ...
  void _ensureImages(List<String> ids) {
    ...
    final rng = Random();
    for (final id in ids) {
      _imageById.putIfAbsent(id, () => _achImages[rng.nextInt(_achImages.length)]);
    }
  }
            ...
            child: Padding(
              ...
              child: BlocBuilder<AchievementsBloc, AchievementsState>(
                ...
                builder: (context, state) {
                  ...
                  final ids = state.achievements.map((e) => e.id).toList(growable: false);
                  _ensureImages(ids);
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          image: const DecorationImage(
                            image: AssetImage('assets/bg_components/achievement_bg.webp'),
                            fit: BoxFit.fill,
                          ),
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
                                child: Opacity(
                                  opacity: a.isCompleted ? 1.0 : (locked ? 0.7 : 0.9),
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Icon(
                                            a.isCompleted ? Icons.lock_open : (locked ? Icons.lock : Icons.lock_open),
                                      ...
                                      LayoutBuilder(
                                        builder: (context, constraints) {
                                          ...
                                          final fill = (w * percent).clamp(0.0, w);
                                          return Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Container(
                                                ...
                                                child: Stack(
                                                  ...
                                                  children: [
                                                      ...
                                                      child: Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                          gradient: const LinearGradient(
                                                            colors: [Color(0xFFF29517), Color(0xFFFFF053)],
                                                    ...
                                                    IgnorePointer(
                                                      child: Container(
                                                        decoration: BoxDecoration(
                                                          border: Border.all(color: AppColors.progressBorder, width: 2),
                                                          borderRadius: BorderRadius.circular(8),
                                                        ),
                                                      ),
                                                    ),
