...
import 'package:itd_2/general_components/nav_bar.dart';
import 'package:itd_2/services/app_navigator.dart';
import 'package:itd_2/view/main/widgets/goal_pill.dart';
import 'package:itd_2/view/settings/settings_screen.dart';
import '../../blocs/main/bloc.dart';
import '../../blocs/main/event.dart';
import '../../blocs/main/state.dart';
import '../../constants/app_styles.dart';
import 'daily_bonus/daily_bonus_screen.dart';
import 'package:itd_2/services/finance_repository.dart';
import 'package:itd_2/models/user_finance.dart';
import 'package:itd_2/models/shop.dart';
import 'package:itd_2/blocs/shop/event.dart';
...
class _MainScreenState extends State<MainScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadShopSelections() async {
    ...
    if (selectedBackgroundId != null) {
      final matchBg = ShopCatalog.backgrounds.where((e) => e.id == selectedBackgroundId);
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              GestureDetector(
                                onTap: () async {
                                  await Navigator.of(context).pushNamed(DailyBonusScreen.routeName);
                                        ...
                                        child: AnimatedBuilder(
                                          ...
                                          builder: (_, __) => Container(
                                            decoration: BoxDecoration(
                                              boxShadow: [
                                                BoxShadow(
                                                  color: Colors.yellow.withOpacity(0.4 + 0.3 * _glowCtrl.value),
                                                  blurRadius: 30 + 20 * _glowCtrl.value,
                                                  spreadRadius: 4 + 2 * _glowCtrl.value,
                                                ),
                                              ],
                                            ),
                                          ),
                            ...
                            onTap:
                                () => _openGoalEditor(
                                  ...
                                  onSave: (value) async {
                                    ...
                                    if (mounted) context.read<MainBloc>().add(MainStarted());
                                  },
                                ),
