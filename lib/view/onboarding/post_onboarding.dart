...
import '../../blocs/onboarding/state.dart';
import '../../blocs/onboarding/event.dart';
                            ...
                            child: _GoalCard(
                              ...
                              onTapTitle:
                                  () => context.read<OnboardingBloc>().add(
                                    UpdateGoalType(GoalType.saving),
                                  ),
                              onChanged:
                                  (v) => context.read<OnboardingBloc>().add(
                                    UpdateGoalAmount(v),
                                  ),
                            ),
                          ),
                ...
                if (editing)
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        controller.text.isEmpty ? AppTexts.yourGoal : controller.text,
