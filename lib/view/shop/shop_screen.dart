...
import '../../blocs/shop/bloc.dart';
import '../../blocs/shop/state.dart';
...
class _ShopScreenState extends State<ShopScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () => context.pushNamedAndRemoveUntil(SettingsScreen.routeName),
              ...
              child: Padding(
                ...
                child: BlocBuilder<ShopBloc, ShopState>(
                  ...
                  builder: (context, state) {
                    if (state.loading) {
                      return Center(
                        child: Text(AppTexts.loading, style: AppStyles.categoryItem),
                      );
                    }
                    return ListView(
                      children: [
                        ...
                        Text(AppTexts.baskets, style: AppStyles.statList.copyWith(fontSize: 22)),
                        ...
                        Text(AppTexts.backs, style: AppStyles.statList.copyWith(fontSize: 22)),
                        const SizedBox(height: 8),
                        _ItemsGrid(
  ...
  void _onItemTap(ShopItem item, ShopState state) async {
    ...
    final selected = (item.type == ShopItemType.basket
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text('${item.price}', style: AppStyles.yellowText.copyWith(fontSize: 20)),
                  ],
                ),
                const SizedBox(height: 16),
                Row(
    ...
    return Row(
      ...
      children: [
        Container(height: 28, width: 70,
          ...
          child: Center(child: Text('$coins', style: AppStyles.greenButtonText.copyWith(fontSize: 12))),
        ),
      ],
    );
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(item.name,
            style: AppStyles.yellowText.copyWith(fontSize: 14),),
            if (selected)
              Text(AppTexts.selected, style: AppStyles.yellowText.copyWith(fontSize: 16))
            else if (owned)
