...
import '../../blocs/statistic/bloc.dart';
import '../../general_components/nav_bar.dart';
import '../../general_components/month_picker_panel.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () => context.pushNamedAndRemoveUntil(StatisticScreen.routeName),
        ),
        actions: [
          IconButton(onPressed: () => context.pushNamedAndRemoveUntil(SettingsScreen.routeName),
