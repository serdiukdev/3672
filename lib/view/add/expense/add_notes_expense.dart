  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: GameNavBar(
        ...
        onTap: (index) {
          setState(() => _tab = index);
          // TODO: navigate to other modules when implemented
        },
      ),
      body: Container(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            'assets/bg_components/add_expense.webp',
                          ),
                          fit: BoxFit.fill,
                        ),
                      ),
                        ...
                        children: [
                          Container(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText:
                                    _dateFocus.hasFocus ? '' : 'dd-mm-yyyy',
                          ...
                          Container(
                            ...
                            child: TextField(
                              ...
                              onChanged:
                                  (v) => _storage.setDraftExpenseAmount(v),
                            ),
                          ),
                          SizedBox(height: 15),
                          Container(
                            ...
                            child: TextField(
                              ...
                              onChanged:
                                  (v) => _storage.setDraftExpenseDescription(v),
                            ),
                          ),
                        ],
                      ),
