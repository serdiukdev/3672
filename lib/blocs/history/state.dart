...
import 'package:itd_2/blocs/statistic/state.dart' show SelectedPeriod;
...
class HistoryEntry {
  ...
  factory HistoryEntry.fromJson(Map<String, dynamic> json, {required String fallbackCategory}) {
    return HistoryEntry(
...
class HistoryState {
  ...
  Color get accentColor => mode == 'income' ? const Color(0xFF1A7700) : const Color(0xFFA60805);
